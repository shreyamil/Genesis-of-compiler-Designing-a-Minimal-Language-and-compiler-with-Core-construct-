...
{
       0,   461,   461,   477,   478,   486,   490,   491,   492,   493,
     494,   495,   496,   497,   498,   499,   500,   504,   511,   515,
     519,   523,   530,   537,   542,   554,   562,   580,   588,   589,
     596,   600,   607,   614,   621,   628,   632,   636,   640,   647,
     650,   654,   659,   664,   669,   674,   679,   684
};
#endif
...
#line 511 "parser.y"
            {
        add_symbol((yyvsp[0].var), 0, yylineno);
...
#line 515 "parser.y"
                {
        add_symbol((yyvsp[0].var), 1, yylineno);
...
#line 519 "parser.y"
               {
        add_symbol((yyvsp[0].var), 2, yylineno);
...
#line 523 "parser.y"
                {
        add_symbol((yyvsp[0].var), 3, yylineno);
...
#line 628 "parser.y"
                     {
        (yyval.node) = create_node(MATH_FUNC_NODE, 's', 0);
        (yyval.node)->left = (yyvsp[-1].node);
    }
...
#line 632 "parser.y"
                       {
        (yyval.node) = create_node(MATH_FUNC_NODE, 'c', 0);
        (yyval.node)->left = (yyvsp[-1].node);
    }
...
#line 636 "parser.y"
                       {
        (yyval.node) = create_node(MATH_FUNC_NODE, 't', 0);
        (yyval.node)->left = (yyvsp[-1].node);
    }
...
#line 640 "parser.y"
                       {
        (yyval.node) = create_node(MATH_FUNC_NODE, 'l', 0);
        (yyval.node)->left = (yyvsp[-1].node);
    }
